...
<div class="container mt-4">
    ...
    <form action="{{ url('/display-candidates') }}" method="GET" class="mb-3">
        <div class="input-group">
            <input type="search" name="search" id="" class="form-control" placeholder="Search candidate..." autocomplete="off">
