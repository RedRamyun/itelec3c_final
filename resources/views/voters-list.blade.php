                ...
                <div class="voter-container">
                    ...
                    @if(strtolower($electionStatus ?? 'pending') !== 'pending')
                        <div class="election-status-alert">
                            ...
                            <strong>Actions Disabled:</strong> Voter management is locked because the election status is currently "<strong>{{ ucfirst($electionStatus) }}</strong>". 
                            Only viewing is available. To modify voters, the election must be in "Pending" status.
                        </div>
                    @endif
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            @else
                                <button class="btn btn-register disabled" disabled title="Election must be in Pending status to register voters">
                                    + Register New Voter
                                </button>
                            @endif
                        </div>
                        ...
                        <div class="empty-state">
                            ...
                            @else
                                ...
                                <p class="text-muted mt-2">
                                    <small>Election must be in Pending status to register voters</small>
                                </p>
                            @endif
                        </div>
                    @endif
