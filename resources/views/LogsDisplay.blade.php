            ...
            <div class="col-md-11 col-lg-10">
                <div class="log-container">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h1 class="mb-0"><i class="fas fa-history me-2"></i>Activity Logs</h1>
                    </div>

                    <!-- Search + Filter -->
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <form action="{{ route('logs.display') }}" method="GET" class="flex-grow-1 me-3">
                            ...
                            <div class="collapse show mt-2" id="filterCollapse">
                                <div class="card card-body p-3">
                                    ...
                                    <div class="mt-3 d-flex gap-2">
                                        ...
                                        <a href="{{ route('logs.display') }}" class="btn btn-secondary">Reset</a>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <table class="table table-hover align-middle">
                                <thead class="table-header">
                                    <tr>
                                        <th scope="col"></th>
                                        <th scope="col">
                                            <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'id', 'sort_dir' => (request('sort_by') == 'id' && request('sort_dir') == 'asc') ? 'desc' : 'asc']) }}">
                                                ID
                                        ...
                                        <th scope="col">
                                            <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'activity', 'sort_dir' => (request('sort_by') == 'activity' && request('sort_dir') == 'asc') ? 'desc' : 'asc']) }}">
                                                Activity
                                                @if(request('sort_by') == 'activity')
                                                    <i class="fas fa-sort-{{ request('sort_dir') == 'asc' ? 'up' : 'down' }} ms-1"></i>
                                                @else
                                                    <i class="fas fa-sort ms-1"></i>
                                                @endif
                                        ...
                                        <th scope="col">
                                            <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'user_id', 'sort_dir' => (request('sort_by') == 'user_id' && request('sort_dir') == 'asc') ? 'desc' : 'asc']) }}">
                                                User
                                        ...
                                        <th scope="col">
                                            <a href="{{ request()->fullUrlWithQuery(['sort_by' => 'created_at', 'sort_dir' => (request('sort_by') == 'created_at' && request('sort_dir') == 'asc') ? 'desc' : 'asc']) }}">
                                                Date & Time
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <button class="btn-view" data-bs-toggle="modal" data-bs-target="#logModal{{ $log->id }}" title="View Details">
                                                <i class="fas fa-eye"></i>
                                            </button>
                                        </td>
                                        <td>{{ $log->id }}</td>
                                        <td>
                                            <i class="fas fa-circle-notch activity-icon"></i>
                                            {{ $log->activity }}
                                        </td>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            <p class="info-label mb-1">Log ID:</p>
                                                            <p>{{ $log->id }}</p>
                                                        </div>
                                                        <div class="col-6">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <p class="info-label mb-1">User Name:</p>
                                                            <p>
                                                                @if($log->user)
                                                                    {{ $log->user->name }}
                                                                @else
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-12">
                                                            <p class="info-label mb-1">Activity:</p>
                                                            <p><span class="log-badge">{{ $log->activity }}</span></p>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-6">
                                                            <p class="info-label mb-1">Date:</p>
                                                            <p>{{ $log->created_at->format('F d, Y') }}</p>
                                                        </div>
                                                        <div class="col-6">
                                                            <p class="info-label mb-1">Time:</p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <p>{{ $log->updated_at->format('F d, Y - h:i A') }}</p>
                                                        </div>
                                                    </div>
                                                    @endif
                                                </div>
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <p class="mb-4">Activity logs will appear here as users perform actions in the system.</p>
                        </div>
                    @endif
                </div>
            </div>
